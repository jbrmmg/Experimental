...
class CrosswordImage{
    ...
    public CrosswordImage(BufferedImage image) {
        ...
        lookup.put("   *    *****  *    *****  *  * ****        ****    *   **************  ",16); // 3-1
        lookup.put("     *******     *******  *  ********    ********    ***************    ",6); // 13-1
        lookup.put("   *   ******  **  ******  **  *****        ****        ************    ",11); // 3-1 8-1
        lookup.put("   **   *****  **   *****  *  * ****        ****        ************    ",13); // 3-1
        lookup.put("  *    * *****     * ****   *  * ***         ***     *   *************  ",20); // 2-1 4-1 14-1
        lookup.put("  *   * ******   ** *****   *** ****         ***         *********      ",21); // 5-1 6-1
        lookup.put("**  **********  **********  *********  **********  *****************    ",7); // 3-1
        lookup.put("   **   *****  *    *****  *    ****        ****    **  **********      ",14); // 6-1
        lookup.put("  *   * ******   ** *****   *** ****         ***         *************  ",21); // 4-1
        lookup.put("  *  *******     ********    ********    ********   **************      ",9); // 12-1
        ...
        lookup.put("  * *   ******      *****  *    ****        ****************************",24); // 3-1
        lookup.put("    *********   ********  * ********    ********************************",3);
        lookup.put("   **   *****  *    *****  *    ****        ****    **  ***********     ",14); // 15-1// 10-1 12-1
        lookup.put("   ***  *****  **  ******  **  *****    *  *****    *  *************    ",17); // 1-1
        lookup.put("**   *********   *******  *  *******     ********    ****************** ",3); // 3-1
        lookup.put("   *    *****  *    *****  *  * ****        ****        *********      *",18); // 6-1
        lookup.put("   **   *****  *    *****  *    ****        ****    **  **************  ",14); // 2-1 8-1
        lookup.put("   *    *****  *    *****  *  * ****        ****    *   **********      ",16); // 9-1
        lookup.put("   **   *****  *    *****  *    ****        ****    **  ************    ",14); // 4-1
        lookup.put("**   *********   *******  *  *******     ********    ***************    ",3); // 3-1 8-1
        lookup.put("  *      *****       ****   *  * ***         ***     *   **********     ",26); // 14-1
        lookup.put("  * ********    ********    *********   *************************    ***",9); // 2-1
        lookup.put("  *    ****** *    ****** *  * *****       **********************       ",18); // 1-1
        lookup.put("  *    *******       ****   **** ***         ***         *********     *",25); // 5-1
        lookup.put("  *    * *****     * ****   *  * ***         ***     *   **********     ",6); // 10-1
        lookup.put("     *******     *******  *  ********    ********    *****************  ",20); // 4-1
        lookup.put("  *  *   *****       ****   *    ***         ***     **  *************  ",24); // 4-1 6-1 9-1
        lookup.put("   *  * *****  *  * *****  *  * ****        ****    *   *********      *",10); // 5-1
        lookup.put("   *   *****   *   ******  **  ******  **  *****        ****            ",11); // 6-1 11-4 1-12 10-13
        lookup.put("     ********    ********    *******  *  *******     ********    **    *",8); // 10-1 12-4 11-6 14-9 13-10 12-11 2-13 10-14
        lookup.put("   *    ****   *    *****  ***  *****  **  *****        ****            ",12); // 4-1 3-2 10-2 13-4 4-6 10-7 14-7 9-8 4-10 4-13
        lookup.put("   *  * *****  *  * *****  *  * ****        ****    *   *************** ",10); // 11-1
        lookup.put("**   *********   *******  *  *******     ********    **************     ",3); // 2-1 3-1 14-1
        lookup.put("* **********     **********  *******     ********    *************      ",5); // 10-1
        lookup.put("**  *********   *********   ********     *******     ********** **    **",4); // 14-1 3-2 13-2 9-3 11-6 7-7 12-7 9-9 2-11 9-13 15-13
        lookup.put("         ***  *    *******       ****   **** ***         ***            ",25); // 7-3 1-10 10-11 3-13
        lookup.put("     *********   *********   *******  *  *******     ********    *****  ",3);
        lookup.put("**  **********  **********  *********  **********  ***************     *",7);
        lookup.put("  *      *****       ****   *  * ***         ***     *   *********      ",26); // 5-1
        lookup.put("* **********     **********  *******     ********    *************    **",5); // 2-1// 14-1// 3-1 9-2 15-2 3-3 8-3 11-3 5-5 2-7 9-7 3-9 11-10 4-11 9-11 3-14
        lookup.put("   *    *****  ***  *****  **  *****        ****        **********      ",12); // 12-1
        lookup.put("  *  *******     ********    ********    ********   ******************* ",9); // 4-1
        lookup.put("   *   ******  **  ******  **  *****        ****        ***********     ",11); // 8-1
        lookup.put("   **********  **********  *********    ********    ****************    ",1); // 4-1
        lookup.put("   *  * *****  *  * *****  *  * ****        ****    *   **********     *",10); // 10-1
        lookup.put("  *      *****   **  ****   **  ****         ***         ***********    ",22); // 2-1 12-1
        lookup.put("  *  *   *****       ****   *    ***         ***     **  ************** ",23); // 10-1
        lookup.put("  *  *   *****   *   ****   *  * ***         ***         *********      ",24); // 1-1
        lookup.put("   **   *****  **   *****  *  * ****        ****        *************** ",13); // 5-1 10-1
        lookup.put("* **********     **********  *******     ********    *****************  ",5); // 3-1
        lookup.put("* **********     **********  *******     ********    ************      *",5); // 3-1
        lookup.put("   *  * *****  *    *****  *    ****        ****        ***********     ",19); // 13-1
        lookup.put("  *      *****   **  ****   **  ****         ***         *********      ",22); // 5-1 11-1
        lookup.put("   **********  **********  *********    ********    **************      ",1); // 3-1
        lookup.put("  *  *******     ********    ********    ********   ****************    ",9); // 5-1 9-1
        lookup.put("  *    *****  *    ****** **   ****** *  * *****       *************    ",13); // 3-4 5-4 4-5 13-6 15-7 7-8 13-9 13-14 5-15
        lookup.put("  ***  *****  **   ****** *    ****** *    *****       **********    ***",14); // 4-1 9-4 13-10 9-11 2-13 4-15
        lookup.put("    ********  * ********    ********    *********   **************      ",9); // 8-1 9-3 8-9 13-12
        lookup.put("  *      *****       ****   *  * ***         ***     *   *************  ",26); // 9-1
        lookup.put("   **   *****  **   *****  *  * ****        ****        **********      ",13); // 13-1
        lookup.put("  *  *********   ********   ********     *******     *************      ",2); // 11-1
        lookup.put("  *      *****   **  ****   **  ****         ***         *************  ",22); // 5-1 10-1
        lookup.put("   *    *****  *    *****  *  * ****        ****    *   *********      *",16); // 12-1
        lookup.put("  *   * ******   ** *****   *** ****         ***         **********     ",21); // 2-1 6-1
        lookup.put("   *   ******  **  ******  **  *****        ****        **********     *",11); // 14-1
        lookup.put("   ***  *****  **  ******  **  *****    *  *****    *  ************     ",17); // 4-1
        lookup.put("     *   ***  *  *   *****       ****   *    ***         ***     *      ",24); // 11-2 12-3 3-4 12-5 1-9 8-9 7-11 10-13 5-14 11-14 15-14
        lookup.put("   *    ****   *    *****  *    *****  *  * ****        ****    *   **  ",16); // 11-3 14-4 6-7 8-7 11-7 5-11 7-12 11-13 4-14 12-15
        lookup.put("  *  *   *****       ****   *    ***         ***     **  **********     ",24); // 3-1 15-1
        lookup.put("   *   ******  **  ******  **  *****        ****        **********      ",11); // 2-1 3-1
        lookup.put("   *  *******  *    *****  **** ****        ****        *********      *",2); // 13-1
        lookup.put("  *  *********   ********   ********     *******     ***************    ",15); // 7-1
        lookup.put("   **********  **********  *********    ********    ******************* ",1); // 5-1
        lookup.put("*    ********    *******  *  *******     ********    *************      ",8); // 2-1
...
public class OcrTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("E,S,I,A,R,N,T,O,L,C,D,U,G,P,M,H,B,Y,F,V,K,W,Z,X,J,Q");
